...
class S3TokenMgr implements S3Constants {
	...
	private boolean isCommentSymbolVaild;
	...
	private void getNextChar() {
		...
		if (isCommentSymbolVaild && currentChar == '/' && inputLine.charAt(currentColumnNumber) == '/') {
